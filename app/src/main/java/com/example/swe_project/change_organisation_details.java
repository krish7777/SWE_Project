...
public class change_organisation_details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_change_organisation_details);
            ...
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, url, new JSONObject(params), new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject response) {
                    try {
                        ...
                        Intent intent = new Intent(change_organisation_details.this,organisation_login_page.class);
